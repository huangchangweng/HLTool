...
- (void)_defaultConfig {
    ...
    self.topBackgroundColor = [UIColor hl_colorWithString:@"#DDD"];
...
- (void)initView {
    ...
    CGFloat safeBottom = [UIWindow topViewController].view.hl_safeBottom;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"HLPopupListViewCell" forIndexPath:indexPath];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"HLPopupListViewCell"];
